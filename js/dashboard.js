  ...
  try {
    ...
    const rows = c.transactions.slice().reverse().map(t => `
      <tr>
        ...
        <td style="color:${t.type === "credit" ? "#A8472E" : "#2E7D5B"}">${t.type === "credit" ? "+" : "−"}${UI.money(t.amount)}</td>
    ...
    wrap.innerHTML = `
      <div style="display:flex; align-items:center; gap:14px; border-bottom:2px solid #D8B25A; padding-bottom:16px; margin-bottom:20px;">
