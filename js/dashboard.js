...
function renderExpiryAlert() {
  ...
  if (daysLeft !== null && daysLeft <= 5) {
    box.innerHTML = `<div class="alert alert-warn">⏳ ينتهي تفعيل حسابك خلال <strong>${arabicDaysPhrase(daysLeft)}</strong>. يرجى التواصل مع الإدارة لتجديد الاشتراك وتفادي توقف الخدمة.</div>`;
  } else {
    box.innerHTML = "";
  }
}
