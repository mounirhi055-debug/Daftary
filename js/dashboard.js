  ...
  try {
    ...
    const rows = c.transactions.slice().reverse().map(t => `
      <tr>
        ...
        <td style="color:${t.type === "credit" ? "#C1503F" : "#6B9A5C"}">${t.type === "credit" ? "+" : "−"}${UI.money(t.amount)}</td>
    ...
    wrap.innerHTML = `
      <div style="display:flex; align-items:center; gap:14px; border-bottom:2px solid #E8A45E; padding-bottom:16px; margin-bottom:20px;">
